...
- **10 大平台专属抓取器**：YouTube、Reddit、Bilibili、知乎、小红书、X(Twitter)、Hacker News、linux.do、百度贴吧、抖音，各平台使用独立 DOM/Shadow DOM/JSON API 策略。
- **两段式 AI 输出**
...
| 抖音          | `*.douyin.com/*`         | `[data-e2e="comment-item"]` DOM 查询 + 滚动加载 + Map 去重        |
